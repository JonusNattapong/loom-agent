...
Loom V1.0 separates three API tiers so application code never depends on
...
| Axis | Constant | V1.0 value | Meaning |
| --- | --- | --- | --- |
| SDK / npm | `SDK_API_VERSION` | `1.0.0` | Public SDK surface. |
...
Loom V1.0 does **not** provide: multi-controller high availability, distributed
